...
package org.apache.zookeeper.txn.test;

import org.apache.jute.test.*;
public class CreateTxn implements Record {
  private String path;
  private byte[] data;
  private java.util.List<org.apache.zookeeper.data.test.ACL> acl;
  ...
  public CreateTxn(
        String path,
        byte[] data,
        java.util.List<org.apache.zookeeper.data.test.ACL> acl,
        boolean ephemeral,
        int parentCVersion) {
    this.path=path;
    this.data=data;
  ...
  public java.util.List<org.apache.zookeeper.data.test.ACL> getAcl() {
    return acl;
  }
  public void setAcl(java.util.List<org.apache.zookeeper.data.test.ACL> m_) {
    acl=m_;
  }
    ...
    a_.writeBuffer(data,"data");
    {
      ...
      if (acl!= null) {          int len1 = acl.size();
          for(int vidx1 = 0; vidx1<len1; vidx1++) {
            org.apache.zookeeper.data.test.ACL e1 = (org.apache.zookeeper.data.test.ACL) acl.get(vidx1);
  ...
  public void deserialize(InputArchive a_, String tag) throws java.io.IOException {
    ...
    System.out.println("data: "+(new String(data, "UTF-8")));
    {
      ...
      if (vidx1!= null) {          acl=new java.util.ArrayList<org.apache.zookeeper.data.test.ACL>();
          for (; !vidx1.done(); vidx1.incr()) {
    org.apache.zookeeper.data.test.ACL e1;
    e1= new org.apache.zookeeper.data.test.ACL();
    a_.readRecord(e1,"e1");
            acl.add(e1);
          }
      }
  ...
  public boolean equals(Object peer_) {
    ...
    if (!ret) return ret;
    ret = org.apache.jute.test.Utils.bufEquals(data,peer.data);
    if (!ret) return ret;
